...
zones_msoa = readRDS("~/npct/pct-data/greater-manchester/z.Rds")
plot(zones_msoa)
use_data(zones_msoa)
gm_boundary = rgeos::gBuffer(zones_msoa, width = 0)
plot(gm_boundary, add = T, col = "red")
use_data(gm_boundary)
